        ...
        <form action="{{route('penjualan.update', $penjualan->id)}}" 
          ...
          <div class="form-group">
            ...
            <select name="barang" id="barang" class="form-control @error('barang') is-invalid @enderror">
              <option value="{{$penjualan->barang}}">{{$penjualan->barang->nama}}</option>
          ...
          <div class="form-group">
            ...
            <select name="pembeli" id="pembeli" class="form-control @error('pembeli') is-invalid @enderror">
              <option value="{{$penjualan->pembeli}}">{{$penjualan->pembeli->nama}}</option>
